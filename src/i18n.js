...
const translations = {
  en: {
    ...
    'startup.subtitle':     'Plan your solar installation',
    ...
    'startup.projectDesc':  'Plan a real PV installation. Enter building dimensions and annual consumption — the app recommends panel count, calculates yearly energy production, savings or payback period .',
    ...
    'startup.addressPlaceholder':  'e.g. Nitra, Slovakia',
    ...
    'startup.panelWp':      'Panel Power (Wp)',
    'startup.manualCount':  'Override Panel Count (optional):',
    'startup.errName':      'Project name is required.',
    'startup.errWidth':     'Building width is required.',
    'startup.errDepth':     'Building depth is required.',
    'startup.errConsumption':'Annual consumption is required.',
    'startup.errWp':        'Panel power is required.',
    ...
    'label.size':           'Size',
    'label.rotate':         'Rotate',
    'label.skylightW':      'Width',
    'label.skylightL':      'Length',
    'label.sandboxLimit':   'Panel Limit',
    'label.sideTilt':       'Side Tilt',
  ...
  sk: {
    // Startup screen
    'startup.appTitle':     'PVMizer 2.0',
    'startup.subtitle':     'Naplánujte svoju solárnu inštaláciu',
    'startup.sandbox':      'Sandbox',
    ...
    'startup.projectDesc':  'Naplánujte si skutočnú FV inštaláciu. Zadajte rozmery budovy a ročnú spotrebu — aplikácia odporučí počet panelov, vypočíta ročnú produkciu, úspory či dobu návratnosti.',
    ...
    'startup.panelWp':      'Výkon panela (Wp)',
    'startup.manualCount':  'Manuálny počet panelov (voliteľné):',
    'startup.errName':      'Názov projektu je povinný.',
    'startup.errWidth':     'Šírka budovy je povinná.',
    'startup.errDepth':     'Hĺbka budovy je povinná.',
    'startup.errConsumption':'Ročná spotreba je povinná.',
    'startup.errWp':        'Výkon panela je povinný.',
    ...
    'label.ridgeLength':    'Dĺžka hrebeňa',
    ...
    'label.skylightW':      'Šírka',
    'label.skylightL':      'Dĺžka',
    'label.sandboxLimit':   'Limit panelov',
    'label.sideTilt':       'Bočný náklon',
    ...
    'settings.rayIntensity':'Intenzita slnečných lúčov',
